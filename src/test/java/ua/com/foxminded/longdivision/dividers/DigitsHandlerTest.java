...
class DigitsHandlerTest {
    ...
    private static DigitsHandler digitHandler;

    @BeforeAll
    public static void initialise() {
        digitHandler = new DigitsHandler();
    }
    ...
    void testGetNumberOfDigits(int input, int expectedOutput) {
        int actualOutput = digitHandler.getNumberOfDigits(input);
    ...
    void testGetDigits() {
        ...
        int[] actual = digitHandler.getDigits(number);
    ...
    void testReplaceDigits() {
        ...
        int[] actual = digitHandler.replaceDigits(digits, startIndex, newDigits);
        assertArrayEquals(expected, actual);
